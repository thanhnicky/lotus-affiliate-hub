...
function demoDb(): MockDb {
  ...
  const demoLinks: AffiliateLink[] = [
    ...
    },
    {
      ...
      channel: "tiktok",
      campaign_name: null,
      affiliate_url: "https://sonlotus.vn/lotus-shield?ref=LTS-DEMO88&utm_source=tiktok",
      clicks: 97,
      conversions: 2,
      total_revenue: 9_600_000,
      commission: 768_000,
